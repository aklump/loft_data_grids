...
class XLSExporterTest extends ExporterBase {
  ...
  public function dataFortestFormatColumnWorksWithExpectedArgumentsProvider() {
    $tests = [];
    $tests[] = ['USD'];
    $tests[] = [''];
    $tests[] = [NULL];
  ...
  /**
   * @dataProvider dataFortestFormatColumnWorksWithExpectedArgumentsProvider
   */
  public function testFormatColumnWorksWithExpectedArguments($currency) {
